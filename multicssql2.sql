...
--
-- Serveur: localhost
-- Généré le : Jeu 17 Octobre 2013 à 15:58
...
--
-- Base de données: `multics`
--

-- --------------------------------------------------------

--
-- Structure de la table `cccam_accrenew`
--
...
--
-- Contenu de la table `cccam_accrenew`
--
...
--
-- Structure de la table `cccam_channelinfo`
--
...
--
-- Contenu de la table `cccam_channelinfo`
--
...
--
-- Structure de la table `cccam_cmgu`
--

CREATE TABLE IF NOT EXISTS `cccam_cmgu` (
  `cmgu_id` int(11) NOT NULL AUTO_INCREMENT,
  `cmgu_host` varchar(50) NOT NULL,
  `cmgu_stealth` varchar(5) DEFAULT NULL,
  `cmgu_active` varchar(2) NOT NULL,
  PRIMARY KEY (`cmgu_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=18 ;

--
-- Contenu de la table `cccam_cmgu`
--

INSERT INTO `cccam_cmgu` (`cmgu_id`, `cmgu_host`, `cmgu_stealth`, `cmgu_active`) VALUES
(17, '127.0.0.1 admin amin', '', '1');

-- --------------------------------------------------------

--
-- Structure de la table `cccam_config`
--
...
--
-- Contenu de la table `cccam_config`
--

INSERT INTO `cccam_config` (`config_id`, `config_value_name`, `config_value`, `config_active`) VALUES
(1, 'CCCAM PORT:', '12000', '1'),
(2, 'CACHE PORT:', '4444', '1'),
(3, 'CACHE TIMEOUT:', '300', '1'),
(5, 'HTTP USER:', 'admin', '1'),
(6, 'HTTP PASS:', 'admin', '1'),
(7, 'CCCAM VERSION:', '2.1.3', '1'),
(8, 'DEFAULT KEY:', '01 02 03 04 05 06 07 08 09 10 11 12 13 14', '1'),
(10, 'HTTP PORT:', '5500', '1');

-- --------------------------------------------------------

--
-- Structure de la table `cccam_emm_blocker`
--
...
--
-- Contenu de la table `cccam_emm_blocker`
--
...
--
-- Structure de la table `cccam_fmgu`
--

CREATE TABLE IF NOT EXISTS `cccam_fmgu` (
  `fmgu_id` int(11) NOT NULL AUTO_INCREMENT,
  `fmgu_host` varchar(50) NOT NULL,
  `fmgu_stealth` varchar(5) DEFAULT NULL,
  `fmgu_active` varchar(2) NOT NULL,
  PRIMARY KEY (`fmgu_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=18 ;

--
-- Contenu de la table `cccam_fmgu`
--

INSERT INTO `cccam_fmgu` (`fmgu_id`, `fmgu_host`, `fmgu_stealth`, `fmgu_active`) VALUES
(17, 'login passe 1', '', '1');

-- --------------------------------------------------------

--
-- Structure de la table `cccam_logevent`
--
...
--
-- Contenu de la table `cccam_logevent`
--
...
--
-- Structure de la table `cccam_mgu`
--

CREATE TABLE IF NOT EXISTS `cccam_mgu` (
  `mgu_id` int(11) NOT NULL AUTO_INCREMENT,
  `mgu_profil` varchar(50) NOT NULL,
  `mgu_port` varchar(5) NOT NULL,
  `mgu_username` varchar(20) NOT NULL,
  `mgu_password` varchar(20) NOT NULL,
  `mgu_des` varchar(100) NOT NULL,
  `mgu_hops` varchar(5) NOT NULL,
  `mgu_stealth` varchar(5) DEFAULT NULL,
  `mgu_active` varchar(2) NOT NULL,
  PRIMARY KEY (`mgu_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=18 ;

--
-- Contenu de la table `cccam_mgu`
--
...
--
-- Structure de la table `cccam_nmgu`
--

CREATE TABLE IF NOT EXISTS `cccam_nmgu` (
  `nmgu_id` int(11) NOT NULL AUTO_INCREMENT,
  `nmgu_profil` varchar(50) NOT NULL,
  `nmgu_port` varchar(30) NOT NULL,
  `nmgu_username` varchar(20) NOT NULL,
  `nmgu_password` varchar(20) NOT NULL,
  `nmgu_des` varchar(100) NOT NULL,
  `nmgu_hops` varchar(30) NOT NULL,
  `nmgu_stealth` varchar(5) DEFAULT NULL,
  `nmgu_active` varchar(2) NOT NULL,
  PRIMARY KEY (`nmgu_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=29 ;

--
-- Contenu de la table `cccam_nmgu`
--
...
--
-- Structure de la table `cccam_option`
--
...
--
-- Contenu de la table `cccam_option`
--
...
--
-- Structure de la table `cccam_paypal`
--
...
--
-- Contenu de la table `cccam_paypal`
--
...
--
-- Structure de la table `cccam_pmgu`
--

CREATE TABLE IF NOT EXISTS `cccam_pmgu` (
  `pmgu_id` int(11) NOT NULL AUTO_INCREMENT,
  `pmgu_host` varchar(100) NOT NULL,
  `pmgu_stealth` varchar(5) DEFAULT NULL,
  `pmgu_active` varchar(2) NOT NULL,
  PRIMARY KEY (`pmgu_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=21 ;

--
-- Contenu de la table `cccam_pmgu`
--

INSERT INTO `cccam_pmgu` (`pmgu_id`, `pmgu_host`, `pmgu_stealth`, `pmgu_active`) VALUES
(20, 'karim.no-ip.info  5555', '', '1');

-- --------------------------------------------------------

--
-- Structure de la table `cccam_profil`
--

CREATE TABLE IF NOT EXISTS `cccam_profil` (
  `profil_id` int(11) NOT NULL AUTO_INCREMENT,
  `profil_value_name` varchar(200) NOT NULL,
  `profil_value` longtext NOT NULL,
  `profil_active` varchar(2) NOT NULL,
  PRIMARY KEY (`profil_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=20 ;

--
-- Contenu de la table `cccam_profil`
--

INSERT INTO `cccam_profil` (`profil_id`, `profil_value_name`, `profil_value`, `profil_active`) VALUES
(1, 'DEFAULT KEY:', '01 02 03 04 05 06 07 08 09 10 11 12 13 14', '1'),
(2, '', '[CsatV10]', '1'),
(3, 'SID DENYLIST:', '1', '1'),
(4, 'SID DENYLIST:', '', '1'),
(5, 'KEY :', '01 02 03 04 05 06 07 08 09 10 11 12 13 14', '1'),
(6, 'PORT :', '5001', '1'),
(7, 'CAID:', '0100', '1'),
(8, 'PROVIDERS:', '003311,003315', '1'),
(9, 'ONID:', '1', '1'),
(10, 'DCW TIMEOUT :', '3500', '1'),
(11, 'SERVER INTERVAL:', '1000', '1'),
(12, 'SERVER TIMEOUT:', '2500', '1'),
(13, 'DCW MINTIME :', '300', '1'),
(14, 'DCW MAXFAILED:', '10', '1'),
(15, 'RETRY NEWCAMD:', '0', '1'),
(16, 'RETRY CCCAM:', '3', '1');

-- --------------------------------------------------------

--
-- Structure de la table `cccam_quote`
--
...
--
-- Contenu de la table `cccam_quote`
--
...
--
-- Structure de la table `cccam_reader`
--
...
--
-- Contenu de la table `cccam_reader`
--
...
--
-- Structure de la table `cccam_servers`
--
...
--
-- Contenu de la table `cccam_servers`
--
...
--
-- Structure de la table `cccam_server_list`
--
...
--
-- Contenu de la table `cccam_server_list`
--
...
--
-- Structure de la table `cccam_stealth`
--
...
--
-- Contenu de la table `cccam_stealth`
--
...
--
-- Structure de la table `cccam_user`
--
...
--
-- Contenu de la table `cccam_user`
--
...
--
-- Structure de la table `list_emusemm`
--
...
--
-- Contenu de la table `list_emusemm`
--
...
--
-- Structure de la table `list_reshare`
--
...
--
-- Contenu de la table `list_reshare`
--
...
--
-- Structure de la table `list_time`
--
...
--
-- Structure de la table `list_ulevel`
--
...
--
-- Contenu de la table `list_ulevel`
--
...
--
-- Structure de la table `list_uphops`
--
...
--
-- Contenu de la table `list_uphops`
--
...
--
-- Structure de la table `list_wantemus`
--
...
--
-- Contenu de la table `list_wantemus`
--

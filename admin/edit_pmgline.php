...
$sql_pmgu = "SELECT * FROM cccam_pmgu WHERE pmgu_id = '$pmgu_id'";
$query_pmgu = mysql_query($sql_pmgu);
$result_pmgu = mysql_fetch_assoc($query_pmgu);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit CACHE PEER ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
             <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">CACHE PEER ::</td>
                <td bgcolor="#5B7CFF"><input name="pmgu_host" type="text" class="LoginBox" id="textfield3" value="<?php echo $result_pmgu['pmgu_host'];?>" /></td>
              </tr>
             
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="pmgu_id" type="hidden" id="pmgu_id" value="<?php echo $_GET['pmgu_id'];?>" />
                  <input name="edit_pmgu" type="hidden" id="edit_pmgu" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>

...
$sql_fmgu = "SELECT * FROM cccam_fmgu WHERE fmgu_id = '$fmgu_id'";
$query_fmgu = mysql_query($sql_fmgu);
$result_fmgu = mysql_fetch_assoc($query_fmgu);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit FLINE ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
             <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">FLINE ::</td>
                <td bgcolor="#5B7CFF"><input name="fmgu_host" type="text" class="LoginBox" id="textfield3" value="<?php echo $result_fmgu['fmgu_host'];?>" /></td>
              </tr>
             
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="fmgu_id" type="hidden" id="fmgu_id" value="<?php echo $_GET['fmgu_id'];?>" />
                  <input name="edit_fmgu" type="hidden" id="edit_fmgu" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>

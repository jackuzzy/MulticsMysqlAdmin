...
if(isset($_POST['edit_mguad']) && $_POST['edit_mguad'] == "ok") {
	include"../config.inc.php";
	$mgu_id = 1;
	$mgu_username = $_POST['user_username'];
	$mgu_password = $_POST['user_password'];
	
       $sql_update_user = "UPDATE cccam_user SET  user_username = '$mgu_username', user_password = '$mgu_password' WHERE user_id = '$mgu_id'";
		mysql_query($sql_update_user);

		header("Refresh:4; URL=/multics-cms-new/index.php?action=logout");
	echo "<html>";
	echo "<head>";
	echo "<style type='text/css'>";
	echo "body {";
...
if(isset($_POST['edit']) && $_POST['edit'] == "userb") {
	include"../config.inc.php";
	$user_id = 1;
	$user_username = $_POST['user_username'];
	$user_password = $_POST['user_password'];
	
		$sql_update_user = "UPDATE cccam_user SET user_username = '$user_username', user_password = '$user_password' WHERE user_id = '$user_id' ";
		mysql_query($sql_update_user) or die (mysql_error());
	header("Refresh:3; URL=list_mgline.php");
	echo "<html>";
	echo "<head>";
	echo "<style type='text/css'>";
	echo "body {";
...
if(isset($_POST['edit_profil']) && $_POST['edit_profil'] == "ok") {
	include"../config.inc.php";
	$profil_id = $_POST['profil_id'];
	$profil_value = $_POST['profil_value'];
	
		$sql_update_profil = "UPDATE cccam_profil SET profil_value = '$profil_value' WHERE profil_id = '$profil_id'";
...
if(isset($_POST['add_profil']) && $_POST['add_profil'] == "ok") {
	include"../config.inc.php";
	$profil_value_name = $_POST['profil_value_name'];
	$profil_value = $_POST['profil_value'];
 		
		$sql_insert_profil = "INSERT INTO cccam_profil ( profil_id, profil_value_name, profil_value, profil_active ) VALUES ( NULL, '$profil_value_name', '$profil_value', '1' ) ";
		mysql_query($sql_insert_profil);
...
if(isset($_POST['edit_mgu']) && $_POST['edit_mgu'] == "ok") {
	include"../config.inc.php";
	$mgu_id = $_POST['mgu_id'];
	
	$mgu_profil = $_POST['mgu_profil'];
	$mgu_username = $_POST['mgu_username'];
	$mgu_password = $_POST['mgu_password'];
	$mgu_des = $_POST['mgu_des'];
	$mgu_hops = $_POST['mgu_hops'];
	$mgu_stealth = $_POST['mgu_stealth'];
	
		$sql_update_mgu = "UPDATE cccam_mgu SET mgu_profil = '$mgu_profil', mgu_username = '$mgu_username', mgu_password = '$mgu_password', mgu_des = '$mgu_des', mgu_hops = '$mgu_hops', mgu_stealth = '$mgu_stealth' WHERE mgu_id = '$mgu_id'";
		mysql_query($sql_update_mgu);
...
if(isset($_POST['add_mgu']) && $_POST['add_mgu'] == "ok") {
	include"../config.inc.php";
	...
	$mgu_stealth = $_POST['mgu_stealth'];
		...
		$sql_insert_mgu = "INSERT INTO cccam_mgu ( mgu_id, mgu_profil, mgu_username, mgu_password, mgu_des, mgu_hops, mgu_stealth, mgu_active ) VALUES ( NULL, '$mgu_profil', '$mgu_username', '$mgu_password', '$mgu_des', '$mgu_hops', '$mgu_stealth', '1' )";
		mysql_query($sql_insert_mgu);
...
if(isset($_POST['edit_pmgu']) && $_POST['edit_pmgu'] == "ok") {
	include"../config.inc.php";
	$pmgu_id = $_POST['pmgu_id'];
	
	$pmgu_host = $_POST['pmgu_host'];
	$pmgu_stealth = $_POST['pmgu_stealth'];
	
		$sql_update_pmgu = "UPDATE cccam_pmgu SET pmgu_host = '$pmgu_host', pmgu_stealth = '$pmgu_stealth' WHERE pmgu_id = '$pmgu_id'";
		mysql_query($sql_update_pmgu);

		header("Refresh:3; URL=list_pmgline.php");
	echo "<html>";
	echo "<head>";
	echo "<style type='text/css'>";
	echo "body {";
	...
	echo "<br>";
	echo "<div align='center' class='TitoloMenu'>";
	echo "Cache Peer - USER. Updated!</br>";
	echo "</div>";
	echo "<br>";
	echo "</td>";
	echo "</tr>";
...
if(isset($_POST['add_pmgu']) && $_POST['add_pmgu'] == "ok") {
	include"../config.inc.php";

	$pmgu_host = $_POST['pmgu_host'];
	$pmgu_stealth = $_POST['pmgu_stealth'];
	
		$sql_insert_pmgu = "INSERT INTO cccam_pmgu ( pmgu_id, pmgu_host, pmgu_stealth, pmgu_active ) VALUES ( NULL, '$pmgu_host', '$pmgu_stealth', '1' )";
		mysql_query($sql_insert_pmgu);
	...
	echo "<br>";
	echo "<div align='center' class='TitoloMenu'>";
	echo "Cache Peer -U SER. Added !</br>";
	echo "</div>";
	echo "<br>";
	echo "</td>";
	echo "</tr>";
...
if(isset($_POST['edit_cmgu']) && $_POST['edit_cmgu'] == "ok") {
	include"../config.inc.php";
	$cmgu_id = $_POST['cmgu_id'];
	
	$cmgu_host = $_POST['cmgu_host'];
	$cmgu_stealth = $_POST['cmgu_stealth'];
	
		$sql_update_cmgu = "UPDATE cccam_cmgu SET cmgu_host = '$cmgu_host', cmgu_stealth = '$cmgu_stealth' WHERE cmgu_id = '$cmgu_id'";
		mysql_query($sql_update_cmgu);

		header("Refresh:3; URL=list_cmgline.php");
	echo "<html>";
	echo "<head>";
	echo "<style type='text/css'>";
	echo "body {";
...
if(isset($_POST['add_cmgu']) && $_POST['add_cmgu'] == "ok") {
	include"../config.inc.php";

	$cmgu_host = $_POST['cmgu_host'];
	$cmgu_stealth = $_POST['cmgu_stealth'];
	
		$sql_insert_cmgu = "INSERT INTO cccam_cmgu ( cmgu_id, cmgu_host, cmgu_stealth, cmgu_active ) VALUES ( NULL, '$cmgu_host', '$cmgu_stealth', '1' )";
		mysql_query($sql_insert_cmgu);
...
if(isset($_POST['edit_fmgu']) && $_POST['edit_fmgu'] == "ok") {
	include"../config.inc.php";
	$fmgu_id = $_POST['fmgu_id'];
	
	$fmgu_host = $_POST['fmgu_host'];
	$fmgu_stealth = $_POST['fmgu_stealth'];
	
		$sql_update_fmgu = "UPDATE cccam_fmgu SET fmgu_host = '$fmgu_host', fmgu_stealth = '$fmgu_stealth' WHERE fmgu_id = '$fmgu_id'";
		mysql_query($sql_update_fmgu);

		header("Refresh:3; URL=list_fmgline.php");
	echo "<html>";
	echo "<head>";
	echo "<style type='text/css'>";
	echo "body {";
...
if(isset($_POST['add_fmgu']) && $_POST['add_fmgu'] == "ok") {
	include"../config.inc.php";

	$fmgu_host = $_POST['fmgu_host'];
	$fmgu_stealth = $_POST['fmgu_stealth'];
	
		$sql_insert_fmgu = "INSERT INTO cccam_fmgu ( fmgu_id, fmgu_host, fmgu_stealth, fmgu_active ) VALUES ( NULL, '$fmgu_host', '$fmgu_stealth', '1' )";
		mysql_query($sql_insert_fmgu);
...
if(isset($_POST['edit_nmgu']) && $_POST['edit_nmgu'] == "ok") {
	include"../config.inc.php";
	$nmgu_id = $_POST['nmgu_id'];
	
	$nmgu_profil = $_POST['nmgu_profil'];
	$nmgu_username = $_POST['nmgu_username'];
	$nmgu_password = $_POST['nmgu_password'];
	$nmgu_des = $_POST['nmgu_des'];
	$nmgu_port = $_POST['nmgu_port'];
       $nmgu_hops = $_POST['nmgu_hops'];

	$nmgu_stealth = $_POST['nmgu_stealth'];
	
		$sql_update_nmgu = "UPDATE cccam_nmgu SET nmgu_profil = '$nmgu_profil', nmgu_username = '$nmgu_username', nmgu_password = '$nmgu_password', nmgu_des = '$nmgu_des', nmgu_port = '$nmgu_port', nmgu_hops = '$nmgu_hops', nmgu_stealth = '$nmgu_stealth' WHERE nmgu_id = '$nmgu_id'";
		mysql_query($sql_update_nmgu);
...
if(isset($_POST['add_nmgu']) && $_POST['add_nmgu'] == "ok") {
	include"../config.inc.php";
	...
	$nmgu_stealth = $_POST['nmgu_stealth'];
		...
		$sql_insert_nmgu = "INSERT INTO cccam_nmgu ( nmgu_id, nmgu_profil, nmgu_username, nmgu_password, nmgu_des, nmgu_port, nmgu_hops, nmgu_stealth, nmgu_active ) VALUES ( NULL, '$nmgu_profil', '$nmgu_username', '$nmgu_password', '$nmgu_des', '$nmgu_port', '$nmgu_hops', '$nmgu_stealth', '1' )";
		mysql_query($sql_insert_nmgu);

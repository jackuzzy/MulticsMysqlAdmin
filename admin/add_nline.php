      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Add NLINE ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
             <tr>
                ...
                <td bgcolor="#5B7CFF"><input name="nmgu_hops" type="text" class="LoginBox" id="textfield3" /></td>
              </tr>

             <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Username ::</td>
                <td bgcolor="#5B7CFF"><input name="nmgu_username" type="text" class="LoginBox" id="textfield3" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Password ::</td>
                <td bgcolor="#5B7CFF"><input name="nmgu_password" type="text" class="LoginBox" id="textfield4" /></td>
              </tr>
               <tr>
                <td width="200" bgcolor="#5B7CFF" class="TestoContenuto">Port ::</td>
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="nmgu_port" type="text" class="LoginBox" id="textfield2" /></td>
              </tr>
                <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">DesKey ::</td>
                <td bgcolor="#5B7CFF"><input name="nmgu_des" type="text" class="LoginBox" id="textfield4" /></td>
              </tr>
               <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="add_nmgu" type="hidden" id="add_nmgu" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>

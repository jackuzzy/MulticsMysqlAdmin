...
$sql_mgu = "SELECT * FROM cccam_mgu WHERE mgu_id = '$mgu_id'";
$query_mgu = mysql_query($sql_mgu);
$result_mgu = mysql_fetch_assoc($query_mgu);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit MGUSER ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
             <tr>
                ...
                <td bgcolor="#5B7CFF"><input name="mgu_username" type="text" class="LoginBox" id="textfield3" value="<?php echo $result_mgu['mgu_username'];?>" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">Password ::</td>
                <td bgcolor="#5B7CFF"><input name="mgu_password" type="text" class="LoginBox" id="textfield4" value="<?php echo $result_mgu['mgu_password'];?>" /></td>
              </tr>
               <tr>
                <td width="200" bgcolor="#5B7CFF" class="TestoContenuto">Profil ::</td>
                <td bgcolor="#5B7CFF"><label for="user_name"></label>
                  <input name="mgu_profil" type="text" class="LoginBox" id="textfield2" value="<?php echo $result_mgu['mgu_profil'];?>" /></td>
              </tr>
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="mgu_id" type="hidden" id="mgu_id" value="<?php echo $_GET['mgu_id'];?>" />
                  <input name="edit_mgu" type="hidden" id="edit_mgu" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>

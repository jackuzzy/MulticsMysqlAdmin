...
$sql_cmgu = "SELECT * FROM cccam_cmgu WHERE cmgu_id = '$cmgu_id'";
$query_cmgu = mysql_query($sql_cmgu);
$result_cmgu = mysql_fetch_assoc($query_cmgu);
      ...
      <tr>
        <td valign="top" bgcolor="#84C1DF"><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
              <td bgcolor="#003366">Edit CLINE ::</td>
              </tr>
        </table>
          <table width="650" border="0" align="center" cellpadding="0" cellspacing="0" class="TitoloMenu">
            <tr>
          ...
          <form id="form" NAME="form" method="post" onSubmit="return nameempty();" action="insert_confirm.php">
            <table width="650" border="0" align="center" cellpadding="0" cellspacing="1">
             <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">CLINE ::</td>
                <td bgcolor="#5B7CFF"><input name="cmgu_host" type="text" class="LoginBox" id="textfield3" value="<?php echo $result_cmgu['cmgu_host'];?>" /></td>
              </tr>
             
              <tr>
                <td bgcolor="#5B7CFF" class="TestoContenuto">&nbsp;</td>
                <td bgcolor="#5B7CFF"><input name="cmgu_id" type="hidden" id="cmgu_id" value="<?php echo $_GET['cmgu_id'];?>" />
                  <input name="edit_cmgu" type="hidden" id="edit_cmgu" value="ok" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
